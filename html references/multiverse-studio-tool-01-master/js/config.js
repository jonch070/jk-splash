...
const PARAMS = {
    ...
    // Module visibility
    showTypography: true,
    showGrid: false,  // Cell noise initially OFF
    ...
    imageEffects: {
        ...
        applyBlurToImages: false, // Apply blur to inserted images (default off)
    ...
    dithering: {
        enabled: true,
        mode: 'pixel',        // 'halftone' (circles) or 'pixel' (Floyd-Steinberg blocks)
        ...
        layers: [
            {
                ...
                textBoxWidth: 80,         // % of canvas width for text wrapping
                strokeWidth: 0,
                strokeColor: '#000000',
                fillColor: '#000000',
                uppercase: false,
